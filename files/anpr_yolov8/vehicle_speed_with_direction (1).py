...
cap = cv2.VideoCapture("C:/Users/SumeetMitra/Downloads/30_up_down.mp4")
filename = os.path.basename("C:/Users/SumeetMitra/Downloads/30_up_down.mp4") 

fourcc = cv2.VideoWriter_fourcc(*'mp4v') 
out = cv2.VideoWriter(filename[:-4]+"_v8_"+"output_vs.mp4", fourcc, 20.0, (int(cap.get(3)), int(cap.get(4))))
...
while True:
    ...
    cv2.imwrite('image'+str(o)+'.png',frame)
    key = cv2.waitKey(1)
    if key == 27:
        break
out.release()
