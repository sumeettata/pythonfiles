...
path_image = 'D:/OneDrive/OneDrive - Tata Insights and Quants/Work/TATA Communications/Data_1/Garbage_new/road_seg/Synthetic_garbage_data2/images/'
path_mask = 'D:/OneDrive/OneDrive - Tata Insights and Quants/Work/TATA Communications/Data_1/Garbage_new/road_seg/Synthetic_garbage_data2/masks/'
path_garbage = 'D:/OneDrive/OneDrive - Tata Insights and Quants/Work/TATA Communications/Data_1/Garbage_new/road_seg/'
path_save = path_garbage+'/Garbage_synthetic_final1/'


files_garbage = glob.glob('C:/Users/SumeetMitra/Downloads/synthetic 70 images/synthetic 70 images/*')
...
def add_defect(steel_image,defect_path,location_defect):
    ...
    resize_factor = random.choice(range(5,300))*0.001
...
for i in tqdm(files):
    ...
    img = cv2.imread(i)
    img_copy = img.copy()
    if os.path.exists(path_mask+os.path.basename(i).replace('.jpg','.png')):
        img_mask = cv2.imread(path_mask+os.path.basename(i).replace('.jpg','.png'),cv2.IMREAD_UNCHANGED)
