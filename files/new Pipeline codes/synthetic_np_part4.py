...
plate_labelpath = "Work/TATA Communications/Data_1/ANPR Stage2/good_images/final/gimp_labels"
...
if not os.path.exists('trail_images38'):
    os.mkdir('trail_images38')

j = 0
while j < 100:
    plate_pth = glob.glob(plate_path+"/*")[2]
    ...
    cv2.imwrite('trail_images38/'+"np_sync"+str(j)+".png",img)
    j = j +1 
