...
path = 'D:/OneDrive/OneDrive - Tata Insights and Quants/Work/TATA Communications/Data_1/ANPR Stage2/good_images/final/New folder/testing_split/non_label_test'
...
for file in tqdm(glob.glob(path+'/*')):
    ...
    cv2.imwrite(path+'_predict/'+file_base,final)