...
## coco classes
YOLO_CLASSES = ('garbage', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
...
## path root folder
ROOT = 'D:/OneDrive/OneDrive - Tata Insights and Quants/Work/TATA Communications/Data_1/Garbage_test_dataset'
...
def xml_transform(root, classes):  
    ...
    print(annopath)
    if os.path.exists(join(root, 'images', '%s.jpg')):
