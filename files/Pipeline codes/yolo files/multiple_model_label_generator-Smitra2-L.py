...
vehicle_model_path = "D:/OneDrive/OneDrive - Tata Insights and Quants/Work/TATA Communications/Python files/downloads/stage_1_1k_+_02_03_2023.pt"
...
save_path = "D:/OneDrive/OneDrive - Tata Insights and Quants/Work/TATA Communications/Csv Files/Images_1_03_2023"+file_time+".csv"
img_path = "D://OneDrive//OneDrive - Tata Insights and Quants//Work//TATA Communications//Data_1//ANPR//images0"
...
vehicle_model = Inference(model_file=vehicle_model_path, confidence_threshold=0.1, iou_threshold=0.1)
                        #   detect_particular_classes=True, particular_classes_list=['np'])
...
if len(main_output_list):
    ...
    csv_output.to_csv(save_path, index=False)
