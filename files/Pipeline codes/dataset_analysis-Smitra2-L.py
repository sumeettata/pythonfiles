...
csv_name = 'D://OneDrive//OneDrive - Tata Insights and Quants//Work//TATA Communications//Csv Files//labels_vehicles-13032023_1037.csv'
Human_class = ['person']
Vehicle_class = ['vehicle_back','vehicle_side','vehicle_front','bicycle', 
                 'car', 'motorcycle', 'bus', 'truck','vehicle','np','auto']
